 ...
 * Copyright (c) 2009-2011 by box_com_app, Inc. All Rights Reserved.
...
//@interface box_com_appObject : NSObject
//@end

@interface box_com_appObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[box_com_appObject class]])
		{
			for (NSString *key in [[(box_com_appObject*)o modules] allKeys])
			{
