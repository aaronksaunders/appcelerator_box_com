...
// in simulator we redefine to format for box_com_app Developer console
...
{\
	NSString * exceptionName = [@"org.box_com_app." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.box_com_app";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIbox_com_appNativeItemNone = -1, 
	UIbox_com_appNativeItemSpinner = -2,
	UIbox_com_appNativeItemProgressBar = -3,
	
	UIbox_com_appNativeItemSlider = -4,
	UIbox_com_appNativeItemSwitch = -5,
	UIbox_com_appNativeItemMultiButton = -6,
	UIbox_com_appNativeItemSegmented = -7,
	
	UIbox_com_appNativeItemTextView = -8,
	UIbox_com_appNativeItemTextField = -9,
	UIbox_com_appNativeItemSearchBar = -10,
	
	UIbox_com_appNativeItemPicker = -11,
	UIbox_com_appNativeItemDatePicker = -12,
	
	UIbox_com_appNativeItemInfoLight = -13,
	UIbox_com_appNativeItemInfoDark = -14,
	
	UIbox_com_appNativeItemDisclosure = -15,
	
	UIbox_com_appNativeItemContactAdd = -16
};
