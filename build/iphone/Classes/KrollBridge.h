...
@interface box_com_appObject : KrollCoverageObject {
#else
@interface box_com_appObject : KrollObject {
#endif
@private
...
extern NSString * box_com_app$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	box_com_appObject *_box_com_app;
	BOOL shutdown;
